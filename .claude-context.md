...
- **Team ID**: 33NJKA4738
- **开发者**: Yiyang Cai
- **Apple ID**: bidagosila@icloud.com
- **证书类型**: Developer ID Application
- **证书位置**: Keychain（已导入）
- **私钥位置**: ~/Desktop/SolarisDeveloperID.key
...
# 3. 创建DMG安装包
# 4. 签名DMG
# 5. 提交Apple公证（需App-Specific Password）
# 6. 附加公证票据（staple）
```
...
### 中期（代码签名 - ✅已完成）
- [x] Apple开发者账号审批（已付688元）
- [x] 获取Team ID：33NJKA4738
- [x] 代码签名（Developer ID Application证书）
- [x] 创建自动化签名脚本（sign_and_notarize.sh）
- [ ] 首次运行脚本，完成公证（Notarization）
- [ ] 分发签名版DMG
...
**最后更新**: 2025-12-24 02:15
**当前状态**: ✅ 代码签名配置完成，自动化脚本已创建（sign_and_notarize.sh）
